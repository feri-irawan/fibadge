// VISITOR BADGE
// Ini digunakan jika tempat penyimpanan data visitor berada di server ini.
// ----------------------------------------------
...
const visitorRoute = (app) => {
  app.get('/visitor/:username/:repo', (req, res) => {
...
const visitorBadgeRoute = (app) => {
  rootRoute(app)
  userRoute(app)
  visitorRoute(app)
}

module.exports = visitorBadgeRoute
